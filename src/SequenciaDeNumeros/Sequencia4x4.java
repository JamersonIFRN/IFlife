...
public class Sequencia4x4 extends JFrame {
    ...
    private void Inicializar() {
        ...
        for (int i = 0; i < quadrados.length; i++) {
            ...
            quadrados[i].addMouseListener(new MouseListener() {
                ...
                @Override
                public void mousePressed(MouseEvent e) {
                    if (ultimoQClicado != u && cartavirada[u] != 1) {
                        ultimoQClicado = u;
        ...
        mostrar = new Timer(10000, action1);
        mostrar.start();
