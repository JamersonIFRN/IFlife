...
public class Sequencia2x2 extends JFrame {

    private JLabel[] quadrados = new JLabel[4];
    ...
    public Sequencia2x2() {
        ...
        add(parar);
        parar.addKeyListener(new KeyListener() {
            @Override
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == 111) {
                    JOptionPane.showMessageDialog(null, "Ops,você trapaceou e perdeu o jogo!");
    ...
    private void Inicializar() {
        ...
        mostrar = new Timer(1000, action1);
        mostrar.start();
