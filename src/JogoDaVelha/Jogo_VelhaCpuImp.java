...
public class Jogo_VelhaCpuImp extends JFrame {
    ...
    private void JogadaCPU() {
        if (ultimajogada == 9 && quadrados[1][1].getText().equals("X") && quadrados[0][0].getText().equals("O") && quadrados[0][2].getText().equals("")) {
            quadrados[0][2].setText("O");
            quadrados[0][2].setForeground(Color.blue);
        } else if (ultimajogada == 1 && quadrados[1][1].getText().equals("X") && quadrados[0][0].getText().equals("O") && quadrados[2][0].getText().equals("")) {
            quadrados[2][0].setText("O");
            quadrados[2][0].setForeground(Color.blue);
        } else if (ultimajogada == 1 && quadrados[1][1].getText().equals("X") && quadrados[2][2].getText().equals("O") && quadrados[0][2].getText().equals("")) {
            quadrados[0][2].setText("O");
            quadrados[0][2].setForeground(Color.blue);
        } else if (ultimajogada == 1 && quadrados[1][1].getText().equals("X") && quadrados[2][2].getText().equals("O") && quadrados[2][0].getText().equals("")) {
            quadrados[2][0].setText("O");
            quadrados[2][0].setForeground(Color.blue);
        } else if (ultimajogada == 3 && quadrados[1][1].getText().equals("X") && quadrados[2][0].getText().equals("O") && quadrados[0][0].getText().equals("")) {
            quadrados[0][0].setText("O");
            quadrados[0][0].setForeground(Color.blue);
        } else if (ultimajogada == 3 && quadrados[1][1].getText().equals("X") && quadrados[2][0].getText().equals("O") && quadrados[2][2].getText().equals("")) {
            quadrados[2][2].setText("O");
            quadrados[2][2].setForeground(Color.blue);
        } else if (ultimajogada == 7 && quadrados[1][1].getText().equals("X") && quadrados[0][2].getText().equals("O") && quadrados[0][0].getText().equals("")) {
            quadrados[0][0].setText("O");
            quadrados[0][0].setForeground(Color.blue);
        } else if (ultimajogada == 7 && quadrados[1][1].getText().equals("X") && quadrados[0][2].getText().equals("O") && quadrados[2][2].getText().equals("")) {
            quadrados[2][2].setText("O");
            quadrados[2][2].setForeground(Color.blue);
        } else if (((ultimajogada == 1 && quadrados[1][1].getText().equals("O") && quadrados[2][2].getText().equals("X")) || (ultimajogada == 3 && quadrados[1][1].getText().equals("O") && quadrados[2][0].getText().equals("X")) || (ultimajogada == 7 && quadrados[1][1].getText().equals("O") && quadrados[0][2].getText().equals("X")) || (ultimajogada == 9 && quadrados[1][1].getText().equals("O") && quadrados[0][0].getText().equals("X")) && (quadrados[0][1].getText().equals("") || quadrados[1][0].getText().equals("") || quadrados[1][2].getText().equals("") || quadrados[2][2].getText().equals("")))) {
            if (quadrados[0][1].getText().equals("")) {
                quadrados[0][1].setText("O");
                quadrados[0][1].setForeground(Color.blue);
            } else if (quadrados[1][0].getText().equals("")) {
                quadrados[1][0].setText("O");
                quadrados[1][0].setForeground(Color.blue);
            } else if (quadrados[1][2].getText().equals("")) {
                quadrados[1][2].setText("O");
                quadrados[1][2].setForeground(Color.blue);
            } else if (quadrados[2][0].getText().equals("")) {
                quadrados[2][0].setText("O");
                quadrados[2][0].setForeground(Color.blue);
            } else if (quadrados[2][2].getText().equals("")) {
                quadrados[2][2].setText("O");
                quadrados[2][2].setForeground(Color.blue);
            }
    ...
    private void JogadaCPUAtaque2() {
        if (ultimajogada == -1) {
        ...
        } else if (ultimajogada == 5 && quadrados[0][0].getText().equals("O") && quadrados[2][2].getText().equals("") && quadrados[2][0].getText().equals("") && quadrados[0][2].getText().equals("")) {
            quadrados[2][2].setText("O");
            quadrados[2][2].setForeground(Color.blue);
        } else if (ultimajogada == 5 && quadrados[0][0].getText().equals("") && quadrados[2][2].getText().equals("O") && quadrados[2][0].getText().equals("") && quadrados[0][2].getText().equals("")) {
            quadrados[0][0].setText("O");
            quadrados[0][0].setForeground(Color.blue);
        } else if (ultimajogada == 5 && quadrados[0][0].getText().equals("") && quadrados[2][2].getText().equals("") && quadrados[2][0].getText().equals("O") && quadrados[0][2].getText().equals("")) {
            quadrados[0][2].setText("O");
            quadrados[0][2].setForeground(Color.blue);
        } else if (ultimajogada == 5 && quadrados[0][0].getText().equals("") && quadrados[2][2].getText().equals("") && quadrados[2][0].getText().equals("") && quadrados[0][2].getText().equals("O")) {
            quadrados[2][0].setText("O");
            quadrados[2][0].setForeground(Color.blue);
        } else if (ultimajogada == 1 && quadrados[2][2].getText().equals("") && quadrados[1][1].getText().equals("X")) {
            quadrados[2][2].setText("O");
            quadrados[2][2].setForeground(Color.blue);
        } else if (ultimajogada == 3 && quadrados[2][0].getText().equals("") && quadrados[1][1].getText().equals("X")) {
            quadrados[2][0].setText("O");
            quadrados[2][0].setForeground(Color.blue);
        } else if (ultimajogada == 7 && quadrados[0][2].getText().equals("") && quadrados[1][1].getText().equals("X")) {
            quadrados[0][2].setText("O");
            quadrados[0][2].setForeground(Color.blue);
        } else if (ultimajogada == 9 && quadrados[0][0].getText().equals("") && quadrados[1][1].getText().equals("X")) {
            quadrados[0][0].setText("O");
            quadrados[0][0].setForeground(Color.blue);
        } else if (quadrados[1][1].getText().equals("")) {
            quadrados[1][1].setText("O");
        ...
        } else if ((quadrados[2][0].getText().equals("O") && quadrados[1][1].getText().equals("O") && quadrados[0][2].getText().equals("")) || (quadrados[0][2].getText().equals("O") && quadrados[1][1].getText().equals("O") && quadrados[2][0].getText().equals("")) || (quadrados[2][0].getText().equals("O") && quadrados[0][0].getText().equals("O") && quadrados[1][1].getText().equals(""))) {
            if ((quadrados[0][2].getText().equals("O") && quadrados[1][1].getText().equals("O") && quadrados[2][0].getText().equals(""))) {
                ...
                quadrados[1][1].setText("O");
                quadrados[1][1].setForeground(Color.blue);
            } else if ((quadrados[1][1].getText().equals("O") && quadrados[2][0].getText().equals("O") && quadrados[0][0].getText().equals(""))) {
                quadrados[0][0].setText("O");
                quadrados[0][0].setForeground(Color.blue);
            }
        } else {
    ...
    private void JogadaCPUAtaque1() {
        if (ultimajogada == -1) {
        ...
        } else if ((ultimajogada == 2 || ultimajogada == 4 || ultimajogada == 6 || ultimajogada == 8) && (quadrados[0][0].getText().equals("") && quadrados[0][2].getText().equals("") && quadrados[2][0].getText().equals("") && quadrados[2][2].getText().equals(""))) {
            if (quadrados[0][0].getText().equals("")) {
                quadrados[0][0].setText("O");
                quadrados[0][0].setForeground(Color.blue);
            } else if (quadrados[0][2].getText().equals("")) {
                quadrados[0][2].setText("O");
                quadrados[0][2].setForeground(Color.blue);
            } else if (quadrados[2][0].getText().equals("")) {
                quadrados[2][0].setText("O");
        ...
        } else if ((quadrados[0][0].getText().equals("O") && quadrados[1][0].getText().equals("O") && quadrados[2][0].getText().equals("")) || (quadrados[1][0].getText().equals("O") && quadrados[2][0].getText().equals("O") && quadrados[0][0].getText().equals("")) || (quadrados[2][0].getText().equals("O") && quadrados[0][0].getText().equals("O") && quadrados[1][0].getText().equals(""))) {
            if ((quadrados[0][0].getText().equals("O") && quadrados[1][0].getText().equals("O") && quadrados[2][0].getText().equals(""))) {
                quadrados[2][0].setText("O");
                quadrados[2][0].setForeground(Color.blue);
            } else if ((quadrados[1][0].getText().equals("O") && quadrados[2][0].getText().equals("O") && quadrados[0][0].getText().equals(""))) {
                quadrados[0][0].setText("O");
                quadrados[0][0].setForeground(Color.blue);
            } else if ((quadrados[0][0].getText().equals("O") && quadrados[2][0].getText().equals("O") && quadrados[1][0].getText().equals(""))) {
                quadrados[1][0].setText("O");
                quadrados[1][0].setForeground(Color.blue);
            }
        } else if ((quadrados[0][1].getText().equals("O") && quadrados[1][1].getText().equals("O") && quadrados[2][1].getText().equals("")) || (quadrados[2][1].getText().equals("O") && quadrados[1][1].getText().equals("O") && quadrados[0][1].getText().equals("")) || (quadrados[2][1].getText().equals("O") && quadrados[0][1].getText().equals("O") && quadrados[1][1].getText().equals(""))) {
            if ((quadrados[0][1].getText().equals("O") && quadrados[1][1].getText().equals("O") && quadrados[2][1].getText().equals(""))) {
                quadrados[2][1].setText("O");
                quadrados[1][1].setForeground(Color.blue);
            } else if ((quadrados[0][1].getText().equals("O") && quadrados[2][1].getText().equals("O") && quadrados[1][1].getText().equals(""))) {
                quadrados[1][1].setText("O");
                quadrados[1][1].setForeground(Color.blue);
            } else if ((quadrados[1][1].getText().equals("O") && quadrados[2][1].getText().equals("O") && quadrados[0][1].getText().equals(""))) {
                quadrados[0][1].setText("O");
                quadrados[0][1].setForeground(Color.blue);
            }
        } else if ((quadrados[0][2].getText().equals("O") && quadrados[1][2].getText().equals("O") && quadrados[2][2].getText().equals("")) || (quadrados[2][2].getText().equals("O") && quadrados[1][2].getText().equals("O") && quadrados[0][2].getText().equals("")) || (quadrados[2][2].getText().equals("O") && quadrados[0][2].getText().equals("O") && quadrados[1][2].getText().equals(""))) {
            if ((quadrados[0][2].getText().equals("O") && quadrados[1][2].getText().equals("O") && quadrados[2][2].getText().equals(""))) {
                quadrados[2][2].setText("O");
                quadrados[2][2].setForeground(Color.blue);
            } else if ((quadrados[0][2].getText().equals("O") && quadrados[2][2].getText().equals("O") && quadrados[1][2].getText().equals(""))) {
                quadrados[1][2].setText("O");
                quadrados[1][2].setForeground(Color.blue);
            } else if ((quadrados[1][2].getText().equals("O") && quadrados[2][2].getText().equals("O") && quadrados[0][2].getText().equals(""))) {
                quadrados[0][2].setText("O");
                quadrados[0][2].setForeground(Color.blue);
            }
        } else if ((ultimajogada == 9 && quadrados[1][1].getText().equals("O") && quadrados[0][0].getText().equals("O") && (quadrados[2][0].getText().equals("") || quadrados[0][2].getText().equals("O")))) {
            if (ultimajogada == 9) {
                if (quadrados[2][2].getText().equals("X") && quadrados[2][1].getText().equals("X")) {
                    quadrados[2][0].setText("O");
                    quadrados[2][0].setForeground(Color.blue);
                } else if (quadrados[0][2].getText().equals("") && !quadrados[0][1].getText().equals("X")) {
                    quadrados[0][2].setText("O");
                    quadrados[0][2].setForeground(Color.blue);
                } else if (quadrados[2][0].getText().equals("") && !quadrados[1][0].getText().equals("X")) {
                    quadrados[2][0].setText("O");
                    quadrados[2][0].setForeground(Color.blue);
                }
            } else if (quadrados[2][2].getText().equals("X") && quadrados[2][1].getText().equals("X")) {
                quadrados[2][0].setText("O");
                quadrados[2][0].setForeground(Color.blue);
            } else if (quadrados[2][0].getText().equals("") && !quadrados[1][0].getText().equals("X")) {
                quadrados[2][0].setText("O");
            ...
            if (ultimajogada == 1) {
                if (quadrados[1][1].getText().equals("X") && quadrados[2][2].getText().equals("")) {
                    ...
                    quadrados[1][1].setText("O");
                    quadrados[1][1].setForeground(Color.blue);
                } else if (primeirajogada == 0 && ((ultimajogada == 1 && quadrados[1][1].getText().equals("O") && quadrados[2][2].getText().equals("")) || (ultimajogada == 3 && quadrados[1][1].getText().equals("O") && quadrados[2][0].getText().equals("") || (ultimajogada == 7 && quadrados[1][1].getText().equals("O") && quadrados[0][2].getText().equals(""))) || (ultimajogada == 9 && quadrados[1][1].getText().equals("O") && quadrados[0][0].getText().equals("")))) {

                    if (quadrados[0][0].getText().equals("X") && quadrados[2][2].getText().equals("")) {
                        quadrados[2][2].setText("O");
                        quadrados[2][2].setForeground(Color.blue);
                    } else if (quadrados[0][2].getText().equals("X") && quadrados[2][0].getText().equals("")) {
                        quadrados[2][0].setText("O");
                        quadrados[2][0].setForeground(Color.blue);
                    } else if (quadrados[2][0].getText().equals("X") && quadrados[0][2].getText().equals("")) {
                        quadrados[0][2].setText("O");
                        quadrados[0][2].setForeground(Color.blue);
                    } else if (quadrados[2][2].getText().equals("X") && quadrados[0][0].getText().equals("")) {
                        quadrados[0][0].setText("O");
                        quadrados[0][0].setForeground(Color.blue);
                    } else if (quadrados[0][2].getText().equals("X") && quadrados[0][0].getText().equals("X")) {
                        quadrados[0][1].setText("O");
                        quadrados[0][1].setForeground(Color.blue);
                    }
    ...
    private void JogadaNormal() {
        if (ultimajogada == 5) {
            ...
            if (primeirajogada == 0 && (quadrados[0][0].getText().equals("") || quadrados[0][2].getText().equals("") || quadrados[2][0].getText().equals("") || quadrados[2][2].getText().equals("X"))) {
                if (quadrados[0][0].getText().equals("")) {
                    quadrados[0][0].setText("O");
                    quadrados[0][0].setForeground(Color.blue);
                } else if (quadrados[0][2].getText().equals("")) {
            ...
            } else if (quadrados[1][1].getText().equals("X") && quadrados[2][1].getText().equals("")) {
                quadrados[2][1].setText("O");
                quadrados[2][1].setForeground(Color.blue);
            } else if (quadrados[0][0].getText().equals("X") && quadrados[0][2].getText().equals("")) {
                quadrados[0][2].setText("O");
    ...
    private void TesteVencedor() {
        ...
        if (empate) {
            ...
            FimJ f = new FimJ(Jogadordavez.getText(), "imp");
            f.setVisible(true);
            dispose();
        }
    ...
    public static void main(String[] args) {
        new Jogo_VelhaCpuImp("Computador");
