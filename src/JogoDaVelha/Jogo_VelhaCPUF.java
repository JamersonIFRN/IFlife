 ...
 * @author DANIEL
 */
public class Jogo_VelhaCPUF extends JFrame {
    ...
    private JPanel fund = new JPanel();

    public Jogo_VelhaCPUF(String jog) {
    ...
    private void JogadaCPU() {
        if (ultimajogada == -1) {
            ...
            if (quadrados[1][1].getText().equals("")) {
                quadrados[1][1].setText("O");
                quadrados[1][1].setForeground(Color.blue);
            } else if (ultimajogada == 1 && quadrados[1][1].getText().equals("X") && quadrados[2][2].getText().equals("")) {
                quadrados[2][2].setText("O");
                quadrados[2][2].setForeground(Color.blue);
            } else if (ultimajogada == 3 && quadrados[1][1].getText().equals("X") && quadrados[2][0].getText().equals("")) {
                quadrados[2][0].setText("O");
                quadrados[2][0].setForeground(Color.blue);
            } else if (ultimajogada == 7 && quadrados[1][1].getText().equals("X") && quadrados[0][2].getText().equals("")) {
                quadrados[0][2].setText("O");
                quadrados[0][2].setForeground(Color.blue);
            } else if (ultimajogada == 9 && quadrados[1][1].getText().equals("X") && quadrados[0][0].getText().equals("")) {
                quadrados[0][0].setText("O");
                quadrados[0][0].setForeground(Color.blue);
            } else {
                Aleatoria();
    ...
    private void MensagemVencedor() {
        ...
        FimJ j = new FimJ(Jogadordavez.getText(), "facil");
        j.setVisible(true);
        dispose();
